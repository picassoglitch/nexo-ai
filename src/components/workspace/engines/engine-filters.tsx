...
import { ENGINE_FILTERS, type EngineFilterKey } from './engine-config';
...
// on narrow screens instead of wrapping into a tall block.
...
export function EngineFilters({
  ...
  return (
    <div
      ...
      role="tablist"
      aria-label="Filtrar engines"
    >
      {ENGINE_FILTERS.map(({ key, label }) => {
